...
import static com.projecteuler.util.MathUtils.*;
...
public class PEExec {
    ...
    public PeResult problem43_ignore() throws IOException {
    ...
    public PeResult problem44() {
        ...
        outer:
        // define a label name outer (just for demo)
    ...
    public PeResult problem60_ignore() {
